...
ALTER TABLE `TICKET` ADD CONSTRAINT `FK_ORDER_ITEM_TO_TICKET` FOREIGN KEY (
`order_item_id`
...
-- schema.sql에 추가
ALTER TABLE PerformanceSeat ADD COLUMN locked_by_user_id LONG;
ALTER TABLE PerformanceSeat ADD CONSTRAINT FK_USERS_TO_PERFORMANCESEAT FOREIGN KEY (locked_by_user_id) REFERENCES Users (user_id);
ALTER TABLE ORDERS ALTER COLUMN order_id BIGINT AUTO_INCREMENT;
ALTER TABLE Ticket ALTER COLUMN ticket_id BIGINT AUTO_INCREMENT;
ALTER TABLE ORDERITEM ALTER COLUMN order_item_id BIGINT AUTO_INCREMENT;